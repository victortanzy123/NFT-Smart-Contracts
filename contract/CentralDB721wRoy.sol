...
contract NFT is ERC721Enumerable, Ownable {
    ...
    uint256 public txRoyaltiesArtist;
    ...
    // Mapping of wallets who dont need to pay royalties:
    ...
    // Functions to OVERRIDE transferFrom Function from openzeppelin standards to include royalty structure:
    ...
    // // Function for payment via ERC20 Token:
    // function payRoyalties(address from) internal {
    //     IERC20 token = IERC20(txFeeToken);
    //     token.transferFrom(from, artist, txRoyaltiesArtist);
    // }


    // Function for owner to configure excluded list:
